...
class _AuthStrings {
  ...
  final String footnotePrefix =
      'By continuing, you agree to MVP Travel\'s premium ';
  ...
  final String weakPassword =
      'The password is too weak (minimum 8 characters with at least one number).';
  final String networkRequestFailed =
...
class _CheckoutStrings {
  ...
  final String successSub =
      'Your expedition is now confirmed. A digital receipt has been sent to your email.';
...
class _TripsStrings {
  ...
  final String confirmationSubtitle =
      'Your expedition is secured and ready for departure.';
  ...
  final String whatsNextStep1 =
      '1 — Confirmation Details: Check your email for full itinerary and digital tickets.';
  final String whatsNextStep2 =
      '2 — Concierge Outreach: A travel concierge will reach out within 24 hours to customize your gear.';
  ...
  final String emptyUpcomingBody =
      'Your next world-class experience is just a click away.';
