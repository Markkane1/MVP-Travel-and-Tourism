...
class _NotificationsScreenState extends ConsumerState<NotificationsScreen> {
  ...
  Future<void> _sendNotification() async {
    ...
    if (_targetType == 'single' && _targetUserIdController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Target User ID is required for single target.')));
      return;
    }

    setState(() => _isSending = true);
    try {
      await ref.read(notificationsApiProvider).sendNotification(
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Notification Dispatched Successfully!')));
                        ...
                        children: [
                          ...
                          DropdownButtonFormField<String>(
                            ...
                            items: const [
                              ...
                              DropdownMenuItem(value: 'cohort', child: Text('Filtered Cohort (Tier)')),
                          ...
                          if (_targetType == 'cohort')
                            DropdownButtonFormField<String>(
                              ...
                              onChanged: (val) {
                                if (val != null) setState(() => _cohortTier = val);
                              },
                            ),
                            ...
                            children: [
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: const InputDecoration(labelText: 'Type (e.g., promo, system)', border: OutlineInputBorder()),
                                ),
                              ),
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: const InputDecoration(labelText: 'Deep Link (optional)', border: OutlineInputBorder()),
                                ),
                              ),
                            ],
                          ),
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                title: Text(payload['title'] ?? 'No Title', style: const TextStyle(fontWeight: FontWeight.bold)),
                                subtitle: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
