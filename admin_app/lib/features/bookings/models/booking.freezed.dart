...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,tourId,status,totalPrice,currency,bookingReferenceCode,refunded,refundReason,adminNotes,lastAdminActionBy,const DeepCollectionEquality().hash(tourSnapshot),const DeepCollectionEquality().hash(participantCounts),const DeepCollectionEquality().hash(paymentReferences),bookingDate,refundedAt,lastAdminActionAt,createdAt);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,tourId,status,totalPrice,currency,bookingReferenceCode,refunded,refundReason,adminNotes,lastAdminActionBy,const DeepCollectionEquality().hash(_tourSnapshot),const DeepCollectionEquality().hash(_participantCounts),const DeepCollectionEquality().hash(_paymentReferences),bookingDate,refundedAt,lastAdminActionAt,createdAt);
