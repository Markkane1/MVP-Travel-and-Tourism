...
@JsonKey(includeToJson: false) String get id; String get userId; String get tourId; String get status; double get totalPrice; String get currency; String? get bookingReferenceCode; bool get refunded; String? get refundReason; String? get adminNotes; String? get lastAdminActionBy; Map<String, dynamic>? get tourSnapshot; Map<String, dynamic>? get participantCounts; Map<String, dynamic>? get paymentReferences; int get adults; int get children; bool get privateVehicle; String get pickupLocation;@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? get date;@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? get bookingDate;@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? get refundedAt;@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? get lastAdminActionAt;@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,tourId,status,totalPrice,currency,bookingReferenceCode,refunded,refundReason,adminNotes,lastAdminActionBy,const DeepCollectionEquality().hash(tourSnapshot),const DeepCollectionEquality().hash(participantCounts),const DeepCollectionEquality().hash(paymentReferences),adults,children,privateVehicle,pickupLocation,date,bookingDate,refundedAt,lastAdminActionAt,createdAt]);

@override
String toString() {
  return 'Booking(id: $id, userId: $userId, tourId: $tourId, status: $status, totalPrice: $totalPrice, currency: $currency, bookingReferenceCode: $bookingReferenceCode, refunded: $refunded, refundReason: $refundReason, adminNotes: $adminNotes, lastAdminActionBy: $lastAdminActionBy, tourSnapshot: $tourSnapshot, participantCounts: $participantCounts, paymentReferences: $paymentReferences, adults: $adults, children: $children, privateVehicle: $privateVehicle, pickupLocation: $pickupLocation, date: $date, bookingDate: $bookingDate, refundedAt: $refundedAt, lastAdminActionAt: $lastAdminActionAt, createdAt: $createdAt)';
}
...
@useResult
$Res call({
@JsonKey(includeToJson: false) String id, String userId, String tourId, String status, double totalPrice, String currency, String? bookingReferenceCode, bool refunded, String? refundReason, String? adminNotes, String? lastAdminActionBy, Map<String, dynamic>? tourSnapshot, Map<String, dynamic>? participantCounts, Map<String, dynamic>? paymentReferences, int adults, int children, bool privateVehicle, String pickupLocation,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? date,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? bookingDate,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? refundedAt,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? lastAdminActionAt,@JsonKey(fromJson: _timestampFromJson, toJson: _timestampToJson) DateTime? createdAt
});
...
/// Create a copy of Booking
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? tourId = null,Object? status = null,Object? totalPrice = null,Object? currency = null,Object? bookingReferenceCode = freezed,Object? refunded = null,Object? refundReason = freezed,Object? adminNotes = freezed,Object? lastAdminActionBy = freezed,Object? tourSnapshot = freezed,Object? participantCounts = freezed,Object? paymentReferences = freezed,Object? adults = null,Object? children = null,Object? privateVehicle = null,Object? pickupLocation = null,Object? date = freezed,Object? bookingDate = freezed,Object? refundedAt = freezed,Object? lastAdminActionAt = freezed,Object? createdAt = freezed,}) {
...
as Map<String, dynamic>?,adults: null == adults ? _self.adults : adults // ignore: cast_nullable_to_non_nullable
...
as bool,pickupLocation: null == pickupLocation ? _self.pickupLocation : pickupLocation // ignore: cast_nullable_to_non_nullable
as String,date: freezed == date ? _self.date : date // ignore: cast_nullable_to_non_nullable
as DateTime?,bookingDate: freezed == bookingDate ? _self.bookingDate : bookingDate // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Booking() when $default != null:
return $default(_that.id,_that.userId,_that.tourId,_that.status,_that.totalPrice,_that.currency,_that.bookingReferenceCode,_that.refunded,_that.refundReason,_that.adminNotes,_that.lastAdminActionBy,_that.tourSnapshot,_that.participantCounts,_that.paymentReferences,_that.adults,_that.children,_that.privateVehicle,_that.pickupLocation,_that.date,_that.bookingDate,_that.refundedAt,_that.lastAdminActionAt,_that.createdAt);case _:
  return orElse();
...
@override@JsonKey() final  bool privateVehicle;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,tourId,status,totalPrice,currency,bookingReferenceCode,refunded,refundReason,adminNotes,lastAdminActionBy,const DeepCollectionEquality().hash(_tourSnapshot),const DeepCollectionEquality().hash(_participantCounts),const DeepCollectionEquality().hash(_paymentReferences),adults,children,privateVehicle,pickupLocation,date,bookingDate,refundedAt,lastAdminActionAt,createdAt]);
...
/// Create a copy of Booking
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? tourId = null,Object? status = null,Object? totalPrice = null,Object? currency = null,Object? bookingReferenceCode = freezed,Object? refunded = null,Object? refundReason = freezed,Object? adminNotes = freezed,Object? lastAdminActionBy = freezed,Object? tourSnapshot = freezed,Object? participantCounts = freezed,Object? paymentReferences = freezed,Object? adults = null,Object? children = null,Object? privateVehicle = null,Object? pickupLocation = null,Object? date = freezed,Object? bookingDate = freezed,Object? refundedAt = freezed,Object? lastAdminActionAt = freezed,Object? createdAt = freezed,}) {
