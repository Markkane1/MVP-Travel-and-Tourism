...
class _UserDetailDialogState extends ConsumerState<UserDetailDialog> {
  ...
  void initState() {
    ...
    _loyaltyPointsController = TextEditingController(
      text: widget.user.loyaltyPoints.toString(),
    );
    _conciergeIdController = TextEditingController(
      text: widget.user.conciergeId ?? '',
    );
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      final points =
          int.tryParse(_loyaltyPointsController.text) ??
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText:
                      'Assigned Concierge ID (leave blank for unassigned)',
                  border: OutlineInputBorder(),
                ),
              ),
            ],
